...
const ISSUE = {
  ...
  watchlist: [
    { entity_id: "merck", name: "Merck & Co.", type: "big_pharma", status: "developing", priority: "high", confidence: "high",
      ...
      summary: "Announced the acquisition of Verastem Oncology for $9B ($64/share) — a 71% premium to the prior close, and the largest ADC transaction since 2025. The target is a single Phase 2 asset: a KRAS-G12D-directed ADC with 41 patients dosed and no randomised data. Management framed the price as 'pipeline urgency ahead of 2028', a direct reference to the Keytruda loss-of-exclusivity cliff that removes roughly $25B of annual revenue. Financed from cash and a $4B bridge; expected to close Q1 2027 pending an FTC review that analysts widely expect to draw a second request. Two other acquirers were reportedly in the process, though neither has confirmed.",
    ...
    { entity_id: "hengrui", name: "Jiangsu Hengrui Pharma", type: "china_pharma", status: "concluded", priority: "high", confidence: "medium",
      ...
      summary: "Out-licensed its PD-1/VEGF bispecific to Bristol Myers Squibb for $1.4B upfront against $6.1B in development and commercial milestones — the largest upfront ever paid for a Chinese-originated oncology asset. Hengrui retains full China rights and books a tiered royalty on ex-China sales. The asset is in three Phase 3 trials in China with a first readout guided for mid-2027. BMS gains a hedge against its own PD-1 franchise erosion without adding discovery headcount.",
    ...
    { entity_id: "astrazeneca", name: "AstraZeneca", type: "big_pharma", status: "developing", priority: "high", confidence: "high",
      ...
      summary: "Expanded its long-running Daiichi Sankyo alliance to two further ADC targets, paying $1.2B upfront for co-development and co-commercialisation rights across the US and EU, with Daiichi retaining Japan. This is the third expansion of the same partnership in four years and takes the total committed capital past $8B. Notably, AstraZeneca took no equity and no control — it bought access to Daiichi's linker-payload chemistry, the only ADC platform with three approved products behind it.",
    ...
    { entity_id: "summit", name: "Summit Therapeutics", type: "biotech", status: "developing", priority: "high", confidence: "medium",
      ...
      summary: "Guided that the pivotal overall-survival readout for ivonescimab in non-small-cell lung cancer will now land in Q4 2026 rather than Q3, attributing the slip to slower-than-modelled event accrual — which can indicate patients living longer, but which the market read as risk. Shares fell 14% on the day. The company reiterated cash runway into 2028 and made no change to trial design or powering. This is the second timeline revision in twelve months.",
    ...
    { entity_id: "akeso", name: "Akeso Biopharma", type: "china_pharma", status: "concluded", priority: "medium", confidence: "medium",
      ...
      summary: "Published updated HARMONi-2 subgroup analyses in a peer-reviewed journal, showing progression-free survival benefit concentrated in PD-L1-high patients and holding across two pre-specified subgroups. The data are incremental rather than practice-changing, but they were delivered on the guided date and survived peer review — reinforcing the class hypothesis that PD-1/VEGF bispecifics beat PD-1 monotherapy in first-line NSCLC.",
    ...
    { entity_id: "pfizer", name: "Pfizer", type: "big_pharma", status: "concluded", priority: "medium", confidence: "medium",
      ...
      summary: "Quietly deprioritised two early-stage oncology programs in its quarterly pipeline update, redirecting spend toward obesity and the Seagen-derived ADC portfolio. Neither discontinued asset had reported human data. The update also reaffirmed 2026 guidance and made no mention of business development in oncology — the first quarter in six without an explicit M&A signal from management.",
    ...
    { entity_id: "arcus", name: "Arcus Biosciences", type: "biotech", status: "concluded", priority: "low", confidence: "medium",
      categories: ["trial_readout"], thesis_impact: "neutral",
      summary: "Reported Phase 2 data for its adenosine-axis combination: safety was clean with no new signals, and overall response rates landed in line with prior guidance — neither a miss nor an inflection. The company maintained its cash runway guidance into H2 2027 and said it would decide on Phase 3 advancement by year-end, which effectively defers the strategic question by two quarters.",
